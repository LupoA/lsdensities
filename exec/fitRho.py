...
def main():
    ...
    ############################# Settings #############################################
    path = './tmax32sigma0.161825Ne9nboot1000mNorm0.6473prec280/Logs'
    file_path_input = 'fit_results_NEWPAUL_nt64_cauchy_gi_as_N0_N40_s0p25.txt'
    output_name = 'fit_results_NEWPAUL_nt64_cauchy_as_gi_double.pdf'
    ...
    params.add('mean_1', value=1.0, min=0.90, max=1.03)
